...
import fr.willy.cryptoback.wallets.infrastructure.repository.api.coinbase.entity.basic.PaginatedData;
import fr.willy.cryptoback.wallets.infrastructure.repository.api.exception.ConnexionError;
...
public class CoinbaseConnexion {
    ...
    protected <T> Set<T> getPaginatedData(String ressourceUrl) {
        ...
        Gson gson = new GsonBuilder()
            ...
            .create();
        Type typeToken = new TypeToken<PaginatedData<T>>() { }.getType();
        Set<T> data = new HashSet<>(30);
